...
[@stellaragent/core](../README.md) / SEMCONV\_VERSION

# Variable: SEMCONV\_VERSION
...
1.0.0 — stable; dashboards and alerts depend on these names.

## See

docs/telemetry-conventions.md
